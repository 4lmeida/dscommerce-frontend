...
export default function ProductForm() {
  ...
  function handleSubmit(event: any) {
    ...
    const requesBody = forms.toValues(formData);

    if (isEditing) {
      requesBody.id = params.productId;
    }

    const request = isEditing
      ? productService.updateRequest(requesBody)
      : productService.insertRequest(requesBody);
            ...
            <div className="dsc-form-controls-container">
              ...
              <div>
                <FormSelect
                  {...formData.categories}
                  options={categories}
                  className="dsc-form-control dsc-form-container-select"
                  styles={selectStyles}
                  onChange={(obj: any) => {
